...
../../../tools/sql-gcloud-proxy/cloud_sql_proxy -instances=ibo-speak:europe-west1:ibo-postgres=tcp:5432 -credential_file=cloud_sql_proxy_service_account_private_key_ibo-speak.json